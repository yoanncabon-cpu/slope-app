    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          ResultTile(label: 'Mensualité', value: formatEuro(monthlyPayment, decimals: true), color: color, highlight: true),
          ResultTile(label: 'Coût total du crédit', value: formatEuro(totalCost)),
          ResultTile(label: 'Total des intérêts payés', value: formatEuro(totalInterest), color: AppColors.warning),
          const SizedBox(height: 8),
          Container(
