    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          ResultTile(label: 'Investissement total', value: formatEuro(totalInvestment)),
          ResultTile(label: 'Rendement brut', value: formatPercent(grossYield), color: color, highlight: true),
          ResultTile(label: 'Rendement net', value: formatPercent(netYield), color: AppColors.success, highlight: true),
          ResultTile(
